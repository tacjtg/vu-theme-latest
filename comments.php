...
div.bubble blockquote { margin: 0px; 	padding: 0px 0px 5px 0px; min-height: 75px;
	background: #FFF url(<?php echo esc_url( get_stylesheet_directory_uri() ) ?>/functions/images/comment-tip.jpg) no-repeat bottom left; }
div.authorcomment blockquote { background: #CCC url(<?php echo esc_url( get_stylesheet_directory_uri() ) ?>/functions/images/comment-tip-grey.jpg) no-repeat bottom left; }
