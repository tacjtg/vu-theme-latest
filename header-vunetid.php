...
<?php
if ($whichbrand == 'Vanderbilt') {
	$brand = 'vu';
} elseif ($whichbrand == 'Blair') {
	$brand = 'blair';
} elseif ($whichbrand == 'CAS') {
	$brand = 'cas';
} elseif ($whichbrand == 'Divinity') {
	$brand = 'div';
} elseif ($whichbrand == 'Engineering') {
	$brand = 'eng';
} elseif ($whichbrand == 'Graduate') {
	$brand = 'grad';
} elseif ($whichbrand == 'Law') {
	$brand = 'law';
} elseif ($whichbrand == 'Medicine') {
	$brand = 'som';
} elseif ($whichbrand == 'Nursing') {
	$brand = 'son';
} elseif ($whichbrand == 'Owen') {
	$brand = 'owen';
} elseif ($whichbrand == 'Peabody') {
	$brand = 'peabody';
} elseif ($whichbrand == 'VUMC') {
	$brand = 'vumc';
} else {
	$brand = 'vu';
}
...
<?php
// if top navigation style is chosen
...
<?php
// are we using a manually built menu or auto building it
